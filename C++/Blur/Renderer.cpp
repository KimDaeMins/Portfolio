...
HRESULT CRenderer::NativeConstruct_Prototype()
{
	...
	if (FAILED(m_pTarget_Manager->Add_RenderTarget(TEXT("Target_LightDepth") , _uint(ViewportDesc.Width), _uint(ViewportDesc.Height), DXGI_FORMAT_R16G16B16A16_UNORM, _float4(1.f, 1.f, 1.f, 1.f))))
		return E_FAIL;
...
HRESULT CRenderer::Render_Blend()
{
	...
	_float Normalization = (Weight[0] + 2.0f * (Weight[1] + Weight[2] + Weight[3] + Weight[4] *Weight[5] *Weight[6] *Weight[7]));
